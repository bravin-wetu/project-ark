        ...
        <div class="flex justify-between items-center">
            <div>
                <h2 class="font-semibold text-xl text-gray-800 leading-tight">
                    Budget Control - {{ $project->name }}
                </h2>
                <p class="text-sm text-gray-500 mt-1">Manage budget locks, thresholds, and revisions</p>
            </div>
            <a href="{{ route('projects.show', $project) }}" class="text-sm text-indigo-600 hover:text-indigo-900">
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                <div class="bg-white rounded-lg shadow-sm overflow-hidden">
                    ...
                    <div class="p-6">
                        @if($summary['is_locked'])
                            ...
                            <form action="{{ route('budget-control.unlock-project', $project) }}" method="POST">
                                @csrf
                        ...
                        @else
                            <form action="{{ route('budget-control.lock-project', $project) }}" method="POST">
                                @csrf
                                <div class="mb-4">
                ...
                <div class="bg-white rounded-lg shadow-sm overflow-hidden">
                    ...
                    <div class="p-6">
                        <form action="{{ route('budget-control.project-thresholds', $project) }}" method="POST">
                            @csrf
                            @method('PUT')
