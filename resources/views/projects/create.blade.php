...
<x-app-layout>
    <div class="max-w-4xl mx-auto">
        ...
        <div class="mb-6">
            ...
            <h1 class="mt-2 text-2xl font-bold text-black">Create New Project</h1>
            <p class="text-gray-500">Set up a donor-funded project workspace</p>
        </div>
        ...
        <div class="mb-8">
            <div class="flex items-center justify-between">
                <div class="flex items-center">
                    ...
                    <span class="ml-2 text-sm font-medium text-black">Project Details</span>
                </div>
        ...
        <form id="project-form" action="{{ route('projects.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div id="step1" class="step-content">
                <div class="bg-white rounded-lg border border-gray-200 p-6">
                    <h2 class="text-lg font-semibold text-black mb-4">Project Information</h2>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <input type="text" id="code" name="code" value="{{ old('code') }}" required
                                class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-1 focus:ring-black focus:border-black uppercase"
                        ...
                        <!-- Donor -->
                        <div>
                            <label for="donor_id" class="block text-sm font-medium text-gray-700 mb-1">Donor *</label>
                        ...
                        <!-- Assigned Hubs -->
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-1">Assigned Hubs</label>
                            <div class="space-y-2 max-h-32 overflow-y-auto border border-gray-200 rounded-md p-3">
                                @foreach($hubs as $hub)
                                    <label class="flex items-center">
                                        <input type="checkbox" name="hubs[]" value="{{ $hub->id }}"
                                            {{ in_array($hub->id, old('hubs', [])) ? 'checked' : '' }}
                                            class="h-4 w-4 text-black border-gray-300 rounded focus:ring-black">
                                        <span class="ml-2 text-sm text-gray-700">{{ $hub->name }}</span>
                                    </label>
                                @endforeach
                            </div>
                        </div>
                ...
                <div class="bg-white rounded-lg border border-gray-200 p-6">
                    ...
                    <div class="mb-6 p-4 border-2 border-dashed border-gray-200 rounded-lg">
                        <div class="text-center">
                            ...
                            <a href="#" class="text-xs text-gray-500 hover:text-gray-700 underline">Download template</a>
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div id="budget-lines-container" class="space-y-3">
                            <!-- Budget line template will be inserted here -->
                        </div>
            ...
            <div id="step3" class="step-content hidden">
                <div class="bg-white rounded-lg border border-gray-200 p-6">
                    ...
                    <div class="mb-6 p-4 bg-gray-50 rounded-lg">
                        <h3 class="text-sm font-medium text-gray-700 mb-3">Project Summary</h3>
                        <dl class="grid grid-cols-2 gap-4 text-sm">
                            <div>
                                <dt class="text-gray-500">Project Name</dt>
                                <dd id="review-name" class="font-medium text-black">-</dd>
                            </div>
                            <div>
                                <dt class="text-gray-500">Project Code</dt>
                                <dd id="review-code" class="font-medium text-black">-</dd>
                            </div>
                            <div>
                                <dt class="text-gray-500">Donor</dt>
                                <dd id="review-donor" class="font-medium text-black">-</dd>
                            </div>
                            <div>
                    ...
                    <div class="mb-6 p-4 border border-gray-200 rounded-lg">
                        <label class="flex items-start">
                            ...
                            <span class="ml-3">
                                ...
                                <span class="block text-xs text-gray-500">Create the project in active status, ready for procurement</span>
                            </span>
                        </label>
                    </div>
    ...
    <script>
        ...
        function validateStep(step) {
            if (step === 1) {
                const required = ['name', 'code', 'donor_id', 'department_id', 'start_date', 'end_date', 'currency'];
        ...
        function updateReview() {
            ...
            document.getElementById('review-code').textContent = document.getElementById('code').value || '-';
            ...
            document.getElementById('review-donor').textContent = donorSelect.options[donorSelect.selectedIndex]?.text || '-';
            ...
            document.getElementById('review-dates').textContent = startDate && endDate ? `${startDate} to ${endDate}` : '-';

            // Update budget lines table
        ...
        // Initialize with one empty budget line
